document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log("mars.js loaded, checking elements:", {
    ...
    // Function to fetch mars distance data
    function fetchmarsDistance() {
        console.log("Fetching mars distance data...");
        ...
        fetch('./data/mars_distance.json?t=' + new Date().getTime())
            .then(response => {
            ...
            .catch(error => {
                console.error('Error fetching mars distance data:', error);
    ...
    if (refreshButton) {
        ...
        refreshButton.addEventListener('click', function() {
            ...
            fetch('/update-planet-data/mars', { method: 'POST' })
