document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log("jupiter.js loaded, checking elements:", {
    ...
    // Function to fetch jupiter distance data
    function fetchjupiterDistance() {
        console.log("Fetching jupiter distance data...");
        ...
        fetch('./data/jupiter_distance.json?t=' + new Date().getTime())
            .then(response => {
            ...
            .catch(error => {
                console.error('Error fetching jupiter distance data:', error);
    ...
    if (refreshButton) {
        ...
        refreshButton.addEventListener('click', function() {
            ...
            fetch('/update-planet-data/jupiter', { method: 'POST' })
