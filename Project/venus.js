document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log("Venus.js loaded, checking elements:", {
    ...
    // Function to fetch Venus distance data
    function fetchVenusDistance() {
        console.log("Fetching Venus distance data...");
        ...
        fetch('./data/venus_distance.json?t=' + new Date().getTime())
            .then(response => {
            ...
            .catch(error => {
                console.error('Error fetching Venus distance data:', error);
    ...
    if (refreshButton) {
        ...
        refreshButton.addEventListener('click', function() {
            ...
            fetch('./update-planet-data/venus', { method: 'POST' })  // Changed from '/update-planet-data/venus' to './update-planet-data/venus'
