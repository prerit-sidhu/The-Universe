document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log("Mercury.js loaded, checking elements:", {
    ...
    function fetchMercuryDistance() {
        console.log("Fetching Mercury distance data...");
        ...
        fetch('./data/mercury_distance.json?t=' + new Date().getTime())
            .then(response => {
    ...
    if (refreshButton) {
        ...
        refreshButton.addEventListener('click', function() {
            ...
            fetch('/update-planet-data/mercury', { method: 'POST' })
