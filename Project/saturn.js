document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log("Saturn.js loaded, checking elements:", {
    ...
    // Function to fetch Saturn distance data
    function fetchSaturnDistance() {
        console.log("Fetching Saturn distance data...");
        ...
        fetch('./data/saturn_distance.json?t=' + new Date().getTime())
            .then(response => {
            ...
            .catch(error => {
                console.error('Error fetching Saturn distance data:', error);
    ...
    if (refreshButton) {
        ...
        refreshButton.addEventListener('click', function() {
            ...
            fetch('/update-planet-data/saturn', { method: 'POST' })
