document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log("neptune.js loaded, checking elements:", {
    ...
    // Function to fetch neptune distance data
    function fetchneptuneDistance() {
        console.log("Fetching neptune distance data...");
        ...
        fetch('./data/neptune_distance.json?t=' + new Date().getTime())
            .then(response => {
            ...
            .catch(error => {
                console.error('Error fetching neptune distance data:', error);
    ...
    if (refreshButton) {
        ...
        refreshButton.addEventListener('click', function() {
            ...
            fetch('/update-planet-data/neptune', { method: 'POST' })
